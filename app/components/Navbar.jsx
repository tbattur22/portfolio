  ...
  return (
    ...
    <nav className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4
        ...
        <a href="" className='flex items-center ml-5 pl-5'>
            ...
            <Image src={assets.my_profile_logo} alt="" className="w-28 my-14 ml-0.5" cursor-pointer="true" />
        </a>

        <ul className="hidden md:flex items-center gap-6 lg:gap-8
            rounded-full px-12 py-3 bg-white opacity-50">
        ...
        <div className='flex items-center gap-4'>
            ...
            px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contact <Image src={assets.arrow_icon} alt="" className="w-3" /></a>
